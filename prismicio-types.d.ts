...
type CourtInterpreterServicesDocumentDataSlicesSlice =
  | TextBlockSlice
  | HeroServicesSlice;

/**
 * Content for Court Interpreter Services documents
 */
interface CourtInterpreterServicesDocumentData {
  /**
   * Title field in *Court Interpreter Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: court_interpreter_services.title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
  ...
  /**
   * Slice Zone field in *Court Interpreter Services*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: court_interpreter_services.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<CourtInterpreterServicesDocumentDataSlicesSlice> /**
   * Meta Description field in *Court Interpreter Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: court_interpreter_services.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *Court Interpreter Services*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: court_interpreter_services.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
  ...
  /**
   * Meta Title field in *Court Interpreter Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: court_interpreter_services.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_title: prismic.KeyTextField;
...
/**
 * Court Interpreter Services document from Prismic
 *
 * - **API ID**: `court_interpreter_services`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type CourtInterpreterServicesDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<CourtInterpreterServicesDocumentData>,
    "court_interpreter_services",
    Lang
  >;
...
type TranslationsServicesDocumentDataSlicesSlice =
  | HeroServicesSlice
  | TextBlockSlice;

/**
 * Content for Translations Services documents
 */
interface TranslationsServicesDocumentData {
  /**
   * Title field in *Translations Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: translations_services.title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
  ...
  /**
   * Slice Zone field in *Translations Services*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: translations_services.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<TranslationsServicesDocumentDataSlicesSlice> /**
   * Meta Description field in *Translations Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: translations_services.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *Translations Services*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: translations_services.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
  ...
  /**
   * Meta Title field in *Translations Services*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: translations_services.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_title: prismic.KeyTextField;
...
/**
 * Translations Services document from Prismic
 *
 * - **API ID**: `translations_services`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 *
 * @typeParam Lang - Language API ID of the document.
 */
export type TranslationsServicesDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<TranslationsServicesDocumentData>,
...
export type AllDocumentTypes =
  | BlogPostDocument
  | CourtInterpreterServicesDocument
  | NavigationDocument
  | PageDocument
  | SettingsDocument
  | TranslationsServicesDocument;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  content_type: prismic.SelectField<
    "Translation Services" | "Court Interpreter Services" | "Blog posts"
  >;
...
/**
 * Primary content in *HeroServices → Primary*
 */
export interface HeroServicesSliceDefaultPrimary {
  /**
   * Background Image field in *HeroServices → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.background_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  background_image: prismic.ImageField<never>;

  /**
   * Heading field in *HeroServices → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;

  /**
   * Body field in *HeroServices → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *HeroServices → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Button Text field in *HeroServices → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.button_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_text: prismic.KeyTextField;

  /**
   * Button Link field in *HeroServices → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_services.primary.button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      CourtInterpreterServicesDocument,
      CourtInterpreterServicesDocumentData,
      CourtInterpreterServicesDocumentDataSlicesSlice,
      NavigationDocument,
      ...
      TranslationsServicesDocument,
      TranslationsServicesDocumentData,
      TranslationsServicesDocumentDataSlicesSlice,
      AllDocumentTypes,
      ContentIndexSlice,
